from src.export_step.export_module import ExportationGeneric

# Instancia de la clase
export2onnx = ExportationGeneric()

# Configuración de prueba
model_path = "./src/training_step/config_training.yaml"  # Ruta al archivo de configuración del modelo
